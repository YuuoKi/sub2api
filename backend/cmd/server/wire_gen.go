...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	generationContentCollector := service.NewGenerationContentCollector(generationContentRepository, configConfig)
	gatewayService := service.ProvideGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, balanceNotifyService, serviceUserPlatformQuotaRepository, generationContentCollector)
	...
	dashboardService := service.ProvideDashboardService(usageLogRepository, dashboardAggregationRepository, dashboardStatsCache, configConfig, concurrencyService)
	...
	systemHandler := handler.ProvideSystemHandler(buildInfo, updateService, systemOperationLockService)
	...
	videoKeyEncryptor, err := repository.ProvideVideoKeyEncryptor(configConfig)
	if err != nil {
		return nil, err
	}
