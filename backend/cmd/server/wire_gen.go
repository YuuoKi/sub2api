...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	dashboardHandler := admin.NewDashboardHandler(dashboardService, dashboardAggregationService, settingService, apiKeyService)
	...
	gatewayService.SetGenerationContentCollector(service.NewGenerationContentCollector(repository.NewGenerationContentRepository(db), configConfig))
	...
	opsWSTicketCache := repository.NewOpsWSTicketCache(redisClient)
	opsHandler := admin.NewOpsHandler(opsService, opsWSTicketCache)
	...
	adminUsageHandler := admin.NewUsageHandler(usageService, apiKeyService, adminService, usageCleanupService, settingService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, handlerVideoHandler, handlerGenerationContentHandler, idempotencyCoordinator, idempotencyCleanupService, videoGatewayWorker)
	jwtAuthMiddleware := middleware.NewJWTAuthMiddleware(authService, userService)
	adminAuthMiddleware := middleware.NewAdminAuthMiddleware(authService, userService, settingService, opsWSTicketCache)
