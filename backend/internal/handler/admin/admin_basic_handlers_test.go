...
func TestUserHandlerEndpoints(t *testing.T) {
	...
	createBody := map[string]any{"email": "new@example.com", "balance": 1, "concurrency": 2}
...
func TestGroupHandlerEndpoints(t *testing.T) {
	...
	body, _ := json.Marshal(map[string]any{"name": "new", "platform": "hc_atom", "subscription_type": "standard"})
	rec = httptest.NewRecorder()
