...
func (s *wechatOAuthRefreshTokenCacheStub) RecordRotatedRefreshToken(context.Context, string, string, time.Duration) error {
	return nil
}

func (s *wechatOAuthRefreshTokenCacheStub) GetRotatedRefreshTokenFamily(context.Context, string) (string, error) {
