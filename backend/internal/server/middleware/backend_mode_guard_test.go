...
func TestBackendModeProductSurfaceMethodPolicy(t *testing.T) {
	allowed := []struct {
		...
		{method: http.MethodPost, path: "/api/v1/admin/accounts/9/connectivity-check"},
		...
		{method: http.MethodDelete, path: "/api/v1/admin/video/providers/9"},
		{method: http.MethodPost, path: "/api/v1/admin/video/providers/9/connectivity-check"},
