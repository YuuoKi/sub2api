...
const (
	...
	PlatformHCAtom      = domain.PlatformHCAtom
...
const (
	...
	SettingKeyUSDCNYRate              = "usd_cny_rate"               // USD/CNY display conversion rate
	SettingKeyCompanyMonthlyBudgetCNY = "company_monthly_budget_cny" // 公司月度总预算（人民币，0=未设置）
