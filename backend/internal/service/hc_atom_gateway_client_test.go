...
func TestHCAtomCatalogFixedRoutes(t *testing.T) {
	tests := []struct {
		...
		{HCAtomCapabilityImageSync, HCAtomImageSeedreamModel, HCAtomImageSeedreamModel, "image", "https://ai-aigc.fzyinghe.com/v1/images/generations", HCAtomAuthBearer, HCAtomPricingGroupImage, syncImageCapabilities(false)},
		{HCAtomCapabilityImageSync, HCAtomImageDoubaoSeedreamModel, HCAtomImageDoubaoSeedreamModel, "image", "https://ai-aigc.fzyinghe.com/v1/images/generations", HCAtomAuthBearer, HCAtomPricingGroupImage, syncImageCapabilities(true)},
		{HCAtomCapabilityImageAsync, HCAtomImageGeminiModel, HCAtomImageGeminiModel, "image", "https://api-aigc.fzyinghe.com/image/generation/tasks", HCAtomAuthBearer, HCAtomPricingGroupImage, asyncImageCapabilities()},
		{HCAtomCapabilityImageAsync, HCAtomImageGPTModel, HCAtomImageGPTModel, "image", "https://api-aigc.fzyinghe.com/image/generation/tasks", HCAtomAuthXAPIKey, HCAtomPricingGroupImage, asyncImageCapabilities()},
		{HCAtomCapabilityImageAsync, HCAtomImageSGPTModel, HCAtomImageSGPTModel, "image", "https://api-aigc.fzyinghe.com/image/generation/tasks", HCAtomAuthXAPIKey, HCAtomPricingGroupImage, asyncImageCapabilities()},
		...
		{HCAtomCapabilityVideoV3, HCAtomSeedanceV3PublicModel, HCAtomSeedanceV3Model, "video", "https://api-aigc.fzyinghe.com/v3/video/tasks", HCAtomAuthBearer, HCAtomPricingGroupVideo, hcAtomV3Capabilities()},
	}
