...
if (Test-Path -LiteralPath $scriptPath -PathType Leaf) {
    ...
    Assert-Match -Content $scriptContent -Pattern 'codex/wujie-console-unification-20260717' -Message 'Delivery branch is not pinned.'
    Assert-Match -Content $scriptContent -Pattern 'D:\\sub2api-trunk\\\.worktrees\\console-unification' -Message 'Delivery worktree absolute path is not pinned.'
    Assert-Match -Content $scriptContent -Pattern '4c6111502eb59e83e2c5d750a2a724aaf1f70b55' -Message 'Required gap-fill product commit is not pinned.'
