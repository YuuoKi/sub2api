<template>
  <header
    class="sticky top-0 z-30 border-b border-ui-border bg-ui-surface/80 backdrop-blur-xl"
    ...
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-4">
        <button
          ...
          class="app-header-control btn-ghost btn-icon lg:hidden"
      ...
      <div class="flex items-center gap-3">
        ...
        <a
          ...
          class="app-header-control flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-dark-400 dark:hover:bg-dark-800 dark:hover:text-white"
        >
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="app-header-control flex items-center gap-2 rounded-xl p-1.5 transition-colors hover:bg-gray-100 dark:hover:bg-dark-800"
