/**
 * Shared USD -> CNY display currency helpers for the Console business views.
 * Console amounts are stored/settled in USD; this renders the CNY-facing figures
 * that Console operators expect, using a supplied or default exchange rate.
 */
