export default {
  ...
  setup: {
    ...
    redis: {
      ...
      description: 'Connect to Redis service',
      host: 'Host',
      port: 'Port',
      ...
      enableTlsHint: 'Use TLS when connecting to Redis (public CA certificate)'
    },
    admin: {
      title: 'Admin Account',
    ...
    ready: {
      ...
      description: 'Review configuration and complete initial setup',
      database: 'Database',
      redis: 'Redis',
    ...
    status: {
      ...
      timeout: 'Service restart took longer than expected. Please refresh the page manually.'
    }
  },
  ...
  keys: {
    ...
    codesGeneratedSuccess: 'Redemption code(s) generated successfully',
    ...
    platformLabel: 'Platform Limit',
    hostLabel: 'Host',
    credentialsPlaceholder: '输入调用凭证',
    credentialsLabel: 'Credentials',
    groupLabel: 'Group',
    selectGroup: 'Select a group',
    statusLabel: 'Status',
    exclusiveObj: 'Exclusive Object',
    ...
    useKeyModal: {
      ...
      noGroupDescription: '此调用凭证尚未分配分组，请先在凭证列表中点击分组列进行分配，然后才能查看使用配置。',
      openai: {
    ...
    ccSwitchNotInstalled: 'CC-Switch 未安装或协议处理程序未注册。请先安装 CC-Switch 或手动复制调用凭证。',
    ccsClientSelect: {
      title: 'Select Client',
  ...
  profile: {
    ...
    authBindings: {
      ...
      countHint: 'Number of codes to generate',
  ...
  admin: {
    ...
    availableChannels: {
      ...
      noGroupsDescription: 'Create groups to better manage API keys and rate limits.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for internal user login',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: 'Welcome to 无界互娱 API 控制台',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">无界互娱 API 控制台 is used for internal pilot operation and demo task management.</p><p style="margin-bottom: 12px;"><b>Core items:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li><b>Task records</b> - Check demo task progress</li><li><b>Generation channels</b> - Review demo channel status</li><li><b>Credentials</b> - Manage internal access</li></ul><p style="color: #10b981; font-weight: 600;">Next, finish the basic setup.</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups separate internal usage scopes.</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>Each group can bind different accounts</li><li>Each group has independent quota rules</li><li>Groups can be public or exclusive</li></ul><p style="margin-top: 16px; color: #10b981; font-weight: 600;">Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
      ...
      keyManage: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>Account setup is complete.</b></p><p style="margin-bottom: 12px;">Final step: create a credential for the internal pilot flow.</p><div style="padding: 8px 12px; background: #eff6ff; border-left: 3px solid #3b82f6; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>Credential purpose:</b><ul style="margin: 8px 0 0 16px;"><li>Used for internal calls</li><li>Each credential is bound to one group</li><li>Quota and expiration can be configured</li><li>Independent usage stats are supported</li></ul></div><p style="margin-top: 16px; color: #10b981; font-weight: 600;">Click "调用凭证" on the left sidebar</p></div>'
      },
      createKey: {
        title: '➕ Create Key',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click the button to create your first credential.</p><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>Tip:</b> Copy and save it immediately after creation; it is only shown once.</p><p style="margin-top: 12px; color: #10b981; font-weight: 600;">Click "创建调用凭证"</p></div>'
      },
      keyName: {
        title: '✏️ 1. Key Name',
      ...
      keySubmit: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">The system will generate a complete credential after clicking create.</p><div style="padding: 8px 12px; background: #fee2e2; border-left: 3px solid #ef4444; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>Important:</b><ul style="margin: 8px 0 0 16px;"><li>The credential is only shown once, copy immediately</li><li>Regenerate it if lost</li><li>Keep it safe and do not share it</li></ul></div><p style="margin-top: 12px; color: #10b981; font-weight: 600;">Click "Create"</p></div>'
      }
    },
    // User tour steps
    user: {
      welcome: {
        title: 'Welcome to 无界互娱 API 控制台',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello, welcome to the internal pilot console.</p><p style="margin-bottom: 12px;"><b>Quick start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>Create a credential</li><li>Copy it to an internal tool</li><li>Review task records</li></ul><p style="color: #10b981; font-weight: 600;">This takes about 1 minute.</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
