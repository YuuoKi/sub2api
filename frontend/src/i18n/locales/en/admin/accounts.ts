export default {
    accounts: {
      ...
      emptyPrerequisite: 'Prerequisite: create a group first, then add and bind an upstream account. Account setup cannot be completed without a group.',
      createGroupFirst: 'Create a group first',
      addUpstreamAccount: 'Add upstream account',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another platform instance.',
