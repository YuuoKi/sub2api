export default {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. wujie-backups), choose a region',
    ...
    groups: {
      ...
      imagePricing: {
        ...
        batchGeminiOnlyHint: 'Batch image generation is currently available only for Gemini or HC-ATOM groups.',
