export default {
    ...
    providerBilling: {
      ...
      periodStart: 'Period start (RFC3339)',
      periodEnd: 'Period end (RFC3339)',
      timezone: 'Timezone',
      currency: 'Currency',
      invoiceNumber: 'Invoice number',
      statementFile: 'Statement file (CSV/XLSX)',
      colExternalLineId: 'external_line_id',
      colUpstreamTaskId: 'upstream_task_id',
      colModel: 'model',
      colGross: 'gross',
      ...
      colProviderAmount: 'Provider amt',
      colInternalAmount: 'Internal amt',
      previewShaLines: 'SHA-256: {sha} · {count} lines',
      showingFirstLines: 'Showing first 20 of {count} lines',
      diffLine: 'line={external} internal={internal} amount {providerAmount} / {internalAmount}'
    },
