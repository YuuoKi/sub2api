export default {
    settings: {
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: '无界 · 企业 AI 中台',
      ...
      payment: {
        ...
        configGuideInline:
          'Enable payment below and add provider instances; each provider dialog includes setup guidance.',
        ...
        findProviderInline: 'Choose EasyPay, Alipay, WeChat Pay, or Stripe as a provider type.',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on orders; the upstream type is sent as EasyPay type.',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: '无界 · 企业 AI 中台',
        useTls: 'Use TLS',
      ...
      betaPolicy: {
        ...
        userIdsHint: 'Leave empty to apply to all users. Specified users match requests from their API keys and take precedence over global rules.',
