export default {
  ...
  nav: {
    ...
    videoCreate: 'Create Task',
    videoCreateDesc: 'Create a task via the internal simulation channel',
    videoTasks: 'Task History',
    videoTaskDetail: 'Task Detail',
    videoProviders: 'Video Providers',
    videoSystemCheck: 'Video System Check',
    videoTasksDesc: 'View video generation task history',
