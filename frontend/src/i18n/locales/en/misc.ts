export default {
  ...
  // Version Badge — immutable deploy identity only
  version: {
    currentVersion: 'Current Deploy Version',
    currentDeployVersion: 'Current Deploy Version',
  ...
  // Onboarding Tour
  onboarding: {
    restartTour: 'Review first-run guide',
    dontShowAgain: 'Do not show again',
    dontShowAgainTitle: 'Close first-run guide',
    confirmDontShow: 'Close this guide? You can reopen it from the user menu.',
    confirmExit: 'Exit the guide? You can reopen it from the user menu.',
    interactiveHint: 'Select the highlighted navigation item to continue',
    navigation: {
      flipPage: 'Next',
      exit: 'Skip guide'
    },
    admin: {
      employee: {
        title: 'Step 1: Open an employee account',
        description: 'Wujie starts with a real employee identity. Create the employee, record the temporary credential securely, and let the employee change it at first sign-in.'
      },
      group: {
        title: 'Step 2: Assign a group',
        description: 'Create or select the controlled group that defines which upstream capacity and billing policy the employee may use.'
      },
      account: {
        title: 'Step 3: Connect an upstream account',
        description: 'Add an upstream account only after the group exists, then bind it to the intended group and verify its enabled state.'
      },
      usage: {
        title: 'Step 4: Verify global usage',
        description: 'Use Global usage to confirm the employee, key, model, tokens, cost, and terminal request evidence after a task runs.'
      }
    },
    user: {
      usage: {
        title: 'Review My usage',
        description: 'Use My usage to verify requests, tokens, costs, and failures recorded for your employee account.'
      }
    }
  },
