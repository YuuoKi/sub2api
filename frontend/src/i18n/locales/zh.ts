export default {
  ...
  auth: {
    ...
    oauthFragmentRejected: '不再接受 URL fragment 中的令牌，请使用授权码流程重新登录。',
    errors: {
  ...
  admin: {
    ...
    generationContent: {
      ...
      adoptionSave: '保存',
      adoptionSaving: '保存中...',
      adoptionSaveFailed: '保存失败，反馈未写入。',
      adoptionNotSaved: {
        content_capture_disabled: '内容采集未开启，反馈未写入。',
        adoption_feedback_unavailable: '采纳反馈不可用，反馈未写入。',
        task_not_found: '任务不存在，反馈未写入。',
        default: '反馈未写入。'
      },
