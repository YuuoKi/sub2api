export default {
    ...
    providerBilling: {
      ...
      matched: '已匹配',
      diff: '差异',
      providerAccountId: '供应商账号 ID',
      periodStart: '账期开始(RFC3339 格式)',
      periodEnd: '账期结束(RFC3339 格式)',
      timezone: '时区',
      currency: '币种',
      invoiceNumber: '发票号',
      statementFile: '账单文件(CSV/XLSX)',
      colExternalLineId: '账单行号(external_line_id)',
      colUpstreamTaskId: '上游任务 ID(upstream_task_id)',
      colModel: '模型',
      colGross: '金额(gross)',
      colCurrency: '币种',
      colSha256: 'SHA-256',
      ...
      colExternal: '账单行号',
      colInternal: '内部单号',
      colProviderAmount: '供应商金额',
      colInternalAmount: '内部金额',
      previewShaLines: 'SHA-256：{sha} · 共 {count} 行',
      showingFirstLines: '仅显示前 20 行，共 {count} 行',
      diffLine: '账单行 {external} · 内部单 {internal} · 金额 {providerAmount} / {internalAmount}'
    },
