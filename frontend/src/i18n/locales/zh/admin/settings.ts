export default {
    settings: {
      ...
      payment: {
        ...
        findProviderInline: '可在服务商类型中选择易支付、支付宝、微信或 Stripe。',
        minAmount: '最低金额',
        maxAmount: '最高金额',
        dailyLimit: '每日限额',
        ...
        easypayCustomMethodsHint: '添加当前易支付服务商额外支持的支付方式。支付方式会记录到订单中，上游 type 会作为易支付 type 参数提交。',
      ...
      betaPolicy: {
        ...
        userIds: '指定用户 ID',
        userIdsHint: '留空表示对全部用户生效。指定后仅匹配这些用户的 API Key 请求，且优先于全局规则。',
