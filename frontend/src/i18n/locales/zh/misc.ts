export default {
  ...
  version: {
    currentVersion: '当前部署版本',
    currentDeployVersion: '当前部署版本',
    buildCommit: '构建提交',
    buildDate: '构建时间',
  ...
  // Onboarding Tour
  onboarding: {
    restartTour: '重新查看首次引导',
    dontShowAgain: '不再提示',
    dontShowAgainTitle: '关闭首次引导',
    confirmDontShow: '关闭本次引导？之后仍可从用户菜单重新打开。',
    confirmExit: '退出引导？之后仍可从用户菜单重新打开。',
    interactiveHint: '选择高亮的导航项继续',
    navigation: {
      flipPage: '下一步',
      exit: '跳过引导'
    },
    admin: {
      employee: {
        title: '第 1 步：开通员工',
        description: '无界从真实员工身份开始。创建员工后安全交付临时凭据，并由员工首次登录完成改密。'
      },
      group: {
        title: '第 2 步：分配分组',
        description: '创建或选择受控分组，明确该员工可使用的上游能力与计费规则。'
      },
      account: {
        title: '第 3 步：接入上游账号',
        description: '分组存在后再添加上游账号，将账号绑定到目标分组并确认启用状态。'
      },
      usage: {
        title: '第 4 步：核对全局用量',
        description: '任务执行后，在全局用量中核对员工、密钥、模型、tokens、费用与终态证据。'
      }
    },
    user: {
      usage: {
        title: '查看我的用量',
        description: '在我的用量中核对本人账号产生的请求、tokens、费用与失败记录。'
      }
    }
  },
